class Vetor():
    ...
    def __str__(self): # mostrar o vetor e valor na posição
        # 1 2 3 4
        return ' '.join([str(i)for i in self.__elementos])

    # percorrer todo o nosso vetor de elem buscando o elemento em questão é igual o que passamos como parametro ou falso
    ...
    def remover_elemento_indice(self, posicao):
        ...
        vetor_final = self.__elementos[posicao + 1:] #3 1 vetor_inicial
        self.__elementos = vetor_inicio + vetor_final #1 2 3 5 3 1
        self.__posicao -= 1
